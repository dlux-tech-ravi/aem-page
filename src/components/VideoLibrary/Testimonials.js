...
export default function Testimonials() {
  ...
  return (
    <section className="relative w-full text-white py-16 px-6 md:px-16 overflow-hidden">
       <div
  className="absolute top-[15%] left-[40%] w-80 h-80 rounded-full 
          ...
          <div className="relative lg:-left-[20%]">
            ...
            <div className="flex gap-4 overflow-x-auto snap-x snap-mandatory scrollbar-hide lg:hidden">
              {testimonials.map((item) => (
                <div
                  key={item.id}
                  className="snap-center shrink-0 bg-neutral-900 rounded-xl p-6 w-full max-w-[50%]  shadow-lg"
                >
                  <div className="text-3xl text-white mb-2">
                    <i className="fa-solid fa-quote-left w-5 h-5"></i>
                  </div>
